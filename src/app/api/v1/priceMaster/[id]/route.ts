...
export async function GET(
  ...
  try {
    ...
    const id = params.id;
    const data = await prisma.priceMaster.findUnique({
      where: {
        id,
      },
      include: {
...
export async function PATCH(
  ...
  try {
    ...
    const updatedData = await prisma.priceMaster.update({
      where: { id },
      data: json,
    });
...
export async function DELETE(
  ...
  try {
    ...
    const id = params.id;
    await prisma.priceMaster.delete({
      where: { id },
    });
